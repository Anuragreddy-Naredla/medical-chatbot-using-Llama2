...
#https://huggingface.co/TheBloke/Llama-2-7B-Chat-GGML/tree/main from this link download the model(llama-2-7b-chat.ggmlv3.q4_0.bin) and store in model folder
